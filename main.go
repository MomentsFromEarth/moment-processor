...
func uploadToYouTube(momentID string, videoFilename string) (string, error) {
	...
	data, _ := ioutil.ReadFile(videoFilename)
...
func downloadVideo(queueID string) (string, error) {
